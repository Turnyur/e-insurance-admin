...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
        <a class="navbar-brand d-none d-sm-block" href="/">CHI Plc</a><button
        ...
        <ul class="navbar-nav align-items-center ml-auto">
            ...
            <li class="nav-item dropdown no-caret mr-3 dropdown-user">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
                    href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false"><img class="img-fluid" src="{{$authenticatedAdmin->image ?? asset('storage/uploads/default_profile.png')}}" /></a>
                <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up"
                    aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        <img class="dropdown-user-img" src="{{$authenticatedAdmin->image ?? asset('storage/uploads/default_profile.png')}}" />
                        <div class="dropdown-user-details">
                            <div class="dropdown-user-details-name">{{ $authenticatedAdmin->firstname }}
                                {{ $authenticatedAdmin->lastname }}</div>
                            <div class="dropdown-user-details-email">{{ $authenticatedAdmin->email }}</div>
                        </div>
                    </h6>
            ...
            <nav class="sidenav shadow-right sidenav-light">
                ...
                <div class="sidenav-footer">
                    <div class="sidenav-footer-content">
                        ...
                        <div class="sidenav-footer-title">{{ $authenticatedAdmin->username }}</div>
                    </div>
                </div>
            </nav>
        </div>
